...
def simulator(line):
    ...
    if identifyop(line) == "add":
        ...
        final+=[str(register)]
        output+=[[bin(register["PC"])[2:].zfill(8),bin(int(register["000"]))[2:].zfill(16),bin(int(register["001"]))[2:].zfill(16),bin(int(register["010"]))[2:].zfill(16),bin(int(register["011"]))[2:].zfill(16),bin(int(register["100"]))[2:].zfill(16),bin(int(register["101"]))[2:].zfill(16),bin(int(register["110"]))[2:].zfill(16),register["111"]]]
        return(0)
